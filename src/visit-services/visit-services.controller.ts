...
export class VisitServicesController {
    ...
    @ApiCreatedResponse({ description: "Creates a visit service in the current clinic" })
    @Post()
    ...
    @ApiOkResponse({ description: "Deletes a visit service in the current clinic" })
    @Delete(":id")
    ...
    @ApiOkResponse({ description: "Deletes visit services by visit and tooth (clinic-scoped)" })
